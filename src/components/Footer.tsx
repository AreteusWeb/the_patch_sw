...
const Footer: React.FC = () => {
  ...
  return (
    <div className="w-full px-4 py-2 flex justify-between items-center bg-black/40 backdrop-blur-sm border-t border-white/5 z-[40] pb-[max(0.5rem,env(safe-area-inset-bottom))]">
